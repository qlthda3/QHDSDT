var size = 0;
var placement = 'point';
function categories_Ga_26(feature, value, size, resolution, labelText,
...
case 'Vuông':
        ...
        image: new ol.style.RegularShape({radius: 2.6666666666666665 + size, points: 4,
...
var style_Ga_26 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Ga_26(feature, value, size, resolution, labelText,
